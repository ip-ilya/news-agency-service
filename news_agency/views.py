...
class NewspaperUpdateView(LoginRequiredMixin, UserPassesTestMixin, generic.UpdateView):
    model = Newspaper
...
class NewspaperDeleteView(LoginRequiredMixin, UserPassesTestMixin, generic.DeleteView):
    model = Newspaper
